...
// configuration code at https://nivo.rocks/pie/
// mockPieData is actually the sample data used on configuration page
...
const PieChart = () => {
  ...
  return (
    ...
    <ResponsivePie
      ...
      arcLinkLabelsTextColor={colors.grey[100]} // specifying custom color
